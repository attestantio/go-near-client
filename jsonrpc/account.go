...
func (s *Service) Account(_ context.Context,
	...
	*api.Response[*spec.Account],
	...
	if err != nil {
		return nil, errors.Join(errors.New("failed to marshal account_id to bytes"), client.ErrInvalidOptions)
	}
	methodName := "get_account"
	params := map[string]any{
		"request_type": "call_function",
		"finality":     "final",
		"account_id":   opts.ContractID,
